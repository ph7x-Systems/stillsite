...
register_language_pack(
    LanguagePack(
        ...
        admin_catalog=_bundled_catalog("id"),
        site_labels={
            "blog": "Blog",
            "search": "Cari",
            "admin": "Admin",
            "comments": "Berpartisipasi dalam diskusi",
            "view-cards": "Kartu",
            "view-list": "Daftar",
            ...
            "error-unauthorized": "Akses diperlukan",
            "error-forbidden": "Akses ditolak",
            "error-server": "Terjadi kesalahan",
            "form-received": "Pesan diterima",
            "form-thanks": "Terima kasih — pesan Anda telah dikirim.",
            "form-error": "Tidak dapat mengirim formulir",
            "form-field-required": "Bidang “{label}” wajib diisi.",
            "form-field-email": "“{label}” harus berupa alamat email yang valid.",
            "form-back": "Kembali ke halaman",
            "form-rate-limited": "Terlalu banyak pengiriman — coba lagi sebentar.",
            "preview-banner": "Pratinjau draf — belum dipublikasikan",
        },
        month_names=(
            "Januari",
            "Februari",
